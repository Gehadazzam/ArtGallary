...
import { loginSchema, userSchema } from "~/utils/userSchema";
...
<template>
  <div
    class="flex h-[80vh] flex-col items-center justify-center p-8 rounded-lg"
  >
    <div class="w-full h-full bg-[url('~/public/images/mainbg.svg')] bg-center">
      <!-- Logo -->
      <NuxtLink to="/">
